...
public abstract class Vehicle
{
    ...
    {
        Manufacturer = manufacturer ?? throw new ArgumentNullExseption "Вы не ввели значение";
    }
}
...
public class Car : Vehicle
{
    ...
    public Car(string manufacturer, double engineVolume, decimal maxPayload, string fuelType, string bodyType) : base(manufacturer)
    {
        ...
        FuelType = fuelType ?? throw new ArgumentNullExseption "Вы не ввели значение";
        BodyType = bodyType ?? throw new ArgumentNullExseption "Вы не ввели значение";
    }
}
